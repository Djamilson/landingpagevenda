      ...
      <Content>
        <div>
          <h2>
            ...
            <strong>Toneline Locadora de Veículos</strong>
          </h2>
          ...
          <p>
            ...
            do nosso site é importante para a Toneline Locadora de Veículos.
          </p>

          <p>
            Todas as informações pessoais relativas a membros, assinantes,
            clientes ou visitantes que usem a Toneline Locadora de Veículos
          ...
          <p>
            O uso do Toneline Locadora de Veículos pressupõe a aceitação deste
            Acordo de privacidade. A equipa da Toneline Locadora de Veículos
          ...
          <p>
            tilizamos cookies para armazenar informação, tais como as suas
          ...
          <p>
            O Toneline Locadora de Veículos possui ligações para outros sites,
            os quais, a nosso ver, podem conter informações / ferramentas úteis
            para os nossos visitantes. A nossa política de privacidade não é
            aplicada a sites de terceiros, pelo que, caso visite outro site a
